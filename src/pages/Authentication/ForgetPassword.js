...
const ForgetPasswordPage = props => {
  ...
  document.title = "Reset Password | PIFPerfect";
  return (
    <ParticlesAuth>
              ...
              <Card className="mt-4">
                ...
                <CardBody className="p-4">
                  <div className="text-center mt-2">
                    ...
                    <p className="text-muted">Reset password with PIFPerfect</p>
                  ...
                  <div className="p-2">
                    ...
                    >
                      ...
                      <div className="text-center mt-4">
                        <button className="default__btn_auth" type="submit">Send Reset Link</button>
                      </div>
                    </Form>
                  </div>
                </CardBody>
