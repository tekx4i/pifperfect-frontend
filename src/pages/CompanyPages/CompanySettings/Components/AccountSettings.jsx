      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="row">
          <div className="col-md-6 position-relative">
            <input type="password" className="form-control" placeholder="Enter Old Password" {...register("oldPassword")} />
        ...
        <div className="row">
          ...
          <div className="col-md-6 position-relative">
            <input type="password" className="form-control" placeholder="Confirm New Password" {...register("newPasswordConfirm")} />
            <div className="input-icon">
              <ReactSVG src={lockIcon} />
            </div>
          </div>
