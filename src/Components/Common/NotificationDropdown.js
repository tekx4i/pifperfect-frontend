...
//import images
import Notification from "../../assets/newImages/notification.svg";
...
const NotificationDropdown = () => {
    ...
    return (
        <React.Fragment>
            <Dropdown isOpen={isNotificationDropdown} toggle={toggleNotificationDropdown} className="topbar-head-dropdown header-item">
                <DropdownToggle type="button" tag="button" className="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle">
                    <ReactSVG src={Notification} />
                    <span
                        className="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill " style={{ background: "#082042" }} >0<span
                            className="visually-hidden">unread messages</span></span>
                </DropdownToggle>
                <DropdownMenu className="dropdown-menu-lg dropdown-menu-end p-0">
                    <div className="dropdown-head bg-pattern rounded-top" style={{ background: "#00d5d2" }}>
                        <div className="p-3">
    ...
    <button type="button" className="btn btn-soft-success waves-effect waves-light">
      Show All Notifications <i className="ri-arrow-right-line align-middle"></i>
    </button>
  </div> */}
                            </SimpleBar>
                                                ...
                                                <div className="px-2 fs-15">
                                                    <div className="form-check notification-check">
                                                        <input
                                                            ...
                                                            type="checkbox"
                                                            value=""
                                                            id={`all-notification-check-${index}`}
                                                        />
                                                        <label
                                                            className="form-check-label"
                                                            htmlFor={`all-notification-check-${index}`}
                                                        ></label>
                                                    </div>
                                                </div>
                                            </div>
