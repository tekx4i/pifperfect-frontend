...
const HorizontalLayout = (props) => {
  ...
  useEffect(() => {
    ...
    initMenu();
  }, [path, props.layoutType, location.pathname]);
            ...
            {!item["isHeader"] ? (
              item.subItems ? (
                <li className="nav-item">
                  <Link onClick={item.click} className="nav-link menu-link red" to={item.link ? item.link : "/#"} data-bs-toggle="collapse">
                ...
                <li className="nav-item kkkk">
                  <Link className="nav-link menu-link nnn" to={item.link ? item.link : "/#"}>
